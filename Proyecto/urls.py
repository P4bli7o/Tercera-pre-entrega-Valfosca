...
from AppValfosca.views import index, venta_mayorista, registrar_mayoristas, venta_minorista, registrar_minorista, pedidos, registrar_pedidos, cancelacion_pedidos, registrar_cancelaciones, buscar
